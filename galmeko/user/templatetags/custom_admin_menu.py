...
class _Menu:
    ...
    def admin_apps(self, context, r):
        ...
        data = [context['available_apps'][0], context['available_apps']
                [3], context['available_apps'][2], context['available_apps'][1]]
        for app in data:
            if app['name'] != 'Hospital' and app['name'] != 'Vendor' and app['name'] != 'User':
            ...
            for model in app['models']:
                ...
                if app['name'] == 'Hospital' or app['name'] == 'Vendor' or app['name'] == 'User':
